...
# Constants
c_deb_packages_repo=http://archive.ubuntu.com/ubuntu/dists
c_deb_security_repo=http://archive.ubuntu.com/ubuntu/dists/jammy-security
...
chroot_execute "apt apt install zfsutils-linux zfs-dkms"
...
if [[ $v_encrypt_rpool == "1" ]]; then
  ...
  wget http://ftp.de.debian.org/debian/pool/main/d/dropbear/dropbear-bin_2022.83-1_amd64.deb
  wget http://ftp.de.debian.org/debian/pool/main/d/dropbear/dropbear-initramfs_2022.83-1_all.deb

  chroot_execute "dpkg -i /root/libtommath1_1.2.0-6_amd64.deb"
  chroot_execute "dpkg -i /root/dropbear-bin_2022.83-1_amd64.deb"
  chroot_execute "dpkg -i /root/dropbear-initramfs_2022.83-1_all.deb"
